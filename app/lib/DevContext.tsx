...
export interface DevContextType {
  ...
  activePreviewTab: "preview" | "files" | "changes" | "terminal" | "chats" | "memory-bank" | "git" | "mcp" | "design-system";
  setActivePreviewTab: (tab: "preview" | "files" | "changes" | "terminal" | "chats" | "memory-bank" | "git" | "mcp" | "design-system") => void;
...
export function DevContextProvider({ children }: { children: React.ReactNode }) {
  ...
  const [activePreviewTab, setActivePreviewTab] = useState<"preview" | "files" | "changes" | "terminal" | "chats" | "memory-bank" | "git" | "mcp" | "design-system">("files");
